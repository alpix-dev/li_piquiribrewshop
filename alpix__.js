...
theme.build.header = function(template){
    ...
    $('#theme_header-functions').prepend('<li><button type="button" class="account-trigger">'+ theme.icon.account +'<div><b>Minha Conta</b>Olá, <span>'+ (theme.isLogged ? 'Eduardo' : 'Visitante') +'</span></div></button></li>');
...
theme.functions.init = function(){
    ...
    theme.icon.cart = '<img src="https://cdn.awsli.com.br/2517/'+ window.LOJA_ID +'/arquivos/ico_cart.png"/>';
    ...
    theme.icon.account = '<img src="https://cdn.awsli.com.br/2517/'+ window.LOJA_ID +'/arquivos/ico_account.png"/>';
